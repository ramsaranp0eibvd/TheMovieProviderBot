...
API_ID = int(environ.get('API_ID', '6344048314'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001582702315').split()] #Channel id for auto indexing ( make sure bot is admin )
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002029105832')) #Log channel id ( make sure bot is admin )
